    ...
    <div className='aboutus_page' id = "contact">
      ...
      <div class="container">
        <div class="card">
          ...
          <p class="card__name">Utsav Sinha<br/><font size="3"><i>2nd Year B.E student</i></font><br/><font size="4"></font></p>
        ...
        <div class="card">
          ...
          <p class="card__name">Ankur Keshri<br/><font size="3"><i>2nd Year B.E student</i></font><br/><font size="4"></font></p>
          <div class="grid-container">
          </div>
          <ul class="social-icons">
            <li><a href="https://www.instagram.com/i_m_utsavs/" target="_blank"><i class="fa fa-instagram"></i></a></li>
        ...
        <div class="card">
          ...
          <p class="card__name">Saishwar Anand<br/><font size="3"><i>2nd Year B.E student</i></font><br/><font size="4"></font></p>
          <div class="grid-container">
        </div>
          <ul class="social-icons">
        ...
        <div class="card">
          ...
          <p class="card__name">Rohit Sharma<br/><font size="3"><i>2nd Year B.E student</i></font><br/><font size="4"></font></p>
          <div class="grid-container">
        </div>
          <ul class="social-icons">
            <li><a href="https://www.instagram.com/saishwar_anand_32/" target="_blank"><i class="fa fa-instagram" target="_blank"></i></a></li>
